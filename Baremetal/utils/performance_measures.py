...
node_thrift_port = 9092
controller_ip = '10.0.3.3'

class Measurer(object):
    def __init__(self, args):
        self.console = CustomConsole(node_thrift_port)
        self.socket = conf.L2socket(iface='ve_A')
...
def timed_reader(console):
    ...
    while True:
        ...
        delta = delta - end
        print("result: {}".format(result//(starting_delta+int(end))))
