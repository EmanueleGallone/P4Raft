...
class ExerciseTopo(Topo):
    ...
    def __init__(self, hosts, switches, links, log_dir, bmv2_exe, pcap_dir, **opts):
        ...
        for sw, params in switches.iteritems():
            ...
            self.addSwitch(sw, log_file=None, cls=switchClass) # REMOVE BMV2 LOG
...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
        ...
        self.pcap_dir = None  # removed PCAP
    ...
    def run_exercise(self):
        ...
        ############## EDITED ######################
        import Switch_Register_Manager
        Switch_Register_Manager.external_autoset()
        # this section will perform the autosetting of all the parameters needed by the nodes
        ############################################
